...
- Name: smoke/login.smoke.spec.ts >> OrangeHRM - Employee Management (PIM) >> должен искать сотрудника по ID
- Location: tests/smoke/login.smoke.spec.ts:8:7
...
Call log:
  - waiting for locator('.oxd-table').locator('tbody tr').first() to be visible
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: rodolfa Sandoval
              - generic [ref=e128]: 
    ...
    - generic [ref=e146]:
      ...
      - generic [ref=e226]:
        ...
        - table [ref=e235]:
          ...
          - rowgroup [ref=e266]:
            - row " 0001 Orange Test  " [ref=e268] [cursor=pointer]:
              - cell "" [ref=e269]:
                - generic [ref=e272]:
                  - checkbox "" [ref=e273]
                  - generic [ref=e275]: 
              - cell "0001" [ref=e276]:
                - generic [ref=e277]: "0001"
              - cell "Orange" [ref=e278]:
                - generic [ref=e279]: Orange
              - cell "Test" [ref=e280]:
...
```ts
  ...
  2  | import { BaseComponent } from '../core/base.component';
  3  | 
  4  | export class TableComponent extends BaseComponent {
  5  |   constructor(page: Page, containerSelector: string = '[data-testid="data-table"]') {
  6  |     super(page, containerSelector);
  7  |   }
  8  | 
  9  |   get rows(): Locator {
  10 |     return this.root.locator('tbody tr');
  11 |   }
  12 | 
  13 |   async getRowCount(): Promise<number> {
  14 |     return this.rows.count();
  15 |   }
  16 | 
  17 |   async getRowByText(text: string): Promise<Locator> {
  18 |     return this.rows.filter({ hasText: text });
  19 |   }
  20 | 
  21 |   async getCellValue(row: number, column: number): Promise<string> {
  22 |     return this.rows.nth(row).locator('td').nth(column).innerText();
  23 |   }
  24 | 
  25 |   async sortByColumn(columnName: string): Promise<void> {
  26 |     await this.root.locator(`th`, { hasText: columnName }).click();
  27 |   }
  28 | 
  29 |   async waitForData(): Promise<void> {
> 30 |     await this.rows.first().waitFor({ state: 'visible' });
     |                             ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  31 |   }
  32 | }
  33 | 
